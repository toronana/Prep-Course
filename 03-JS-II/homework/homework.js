...
function operadoresLogicos(num1, num2, num3) {
  ...
  var respuesta = false;
  if(num1 > num2 && num1 > num3 && num1 >= 0) respuesta = "Número 1 es mayor y positivo";
  if(num1<0 || num2<0 || num3<0) respuesta = "Hay negativos";
  if(num3 > num1 && num3 > num2) respuesta = ++num3;
  if(!num1 || !num2 || !num3 ) respuesta = "Error";
  return respuesta;
}
...
function esPrimo(numero) {
  ...
  var respuesta = !(numero == 0 || numero == 1);
  for (let index = 2; index < numero; index++) {    
    if(numero%index == 0) respuesta = false;    
  }
  return respuesta;
}
